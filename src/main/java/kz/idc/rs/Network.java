...
public class Network {
    ...
    public Network(RxHttpClient rxHttpClient, NetworkConfiguration networkConfiguration) {
        this.networkTools = ClientAPIService.network(rxHttpClient, networkConfiguration);
    }
