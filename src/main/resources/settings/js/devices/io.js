...
const setVolumeInput = (io) => {
    enableAudioVolume($(getSlider(volume_input)), $(getValFromSlider(volume_input)), io.volume);
}

const setVolumeOutput = (io) => {
    enableAudioVolume($(getSlider(volume_output)), $(getValFromSlider(volume_output)), io.volume);
}
